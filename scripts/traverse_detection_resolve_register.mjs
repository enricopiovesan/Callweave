...
const manifestPath = join(repoRoot, 'apps', 'callweave-detection-resolve', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-detection-resolve-local', '--json'];
