...
const manifestPath = join(repoRoot, 'apps', 'callweave-privacy-protect', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-privacy-protect-local', '--json'];
