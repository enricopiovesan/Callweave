...
const manifestPath = join(repoRoot, 'apps', 'callweave-evidence-retain', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-evidence-retain-local', '--json'];
