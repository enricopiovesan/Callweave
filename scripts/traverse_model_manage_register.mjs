...
const manifestPath = join(repoRoot, 'apps', 'callweave-model-manage', 'app.manifest.json');
const args = [
  'run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--',
  'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-model-manage-local', '--json',
];
