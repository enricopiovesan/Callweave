...
const manifestPath = join(repoRoot, 'apps', 'callweave-daily-revise', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-daily-revise-local', '--json'];
