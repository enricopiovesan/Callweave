...
const manifestPath = join(repoRoot, 'apps', 'callweave-location-initialize', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-location-initialize-local', '--json'];
