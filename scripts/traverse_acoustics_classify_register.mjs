...
const manifestPath = join(repoRoot, 'apps', 'callweave-acoustics-classify', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-acoustics-classify-local', '--json'];
