...
const manifestPath = join(repoRoot, 'apps', 'callweave-operations-recover', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-operations-recover-local', '--json'];
