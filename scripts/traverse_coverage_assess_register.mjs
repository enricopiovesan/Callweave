...
const manifestPath = join(repoRoot, 'apps', 'callweave-coverage-assess', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-coverage-assess-local', '--json'];
