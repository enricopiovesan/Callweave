...
const manifestPath = join(repoRoot, 'apps', 'callweave-observation-manage', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-observation-manage-local', '--json'];
