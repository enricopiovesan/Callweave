...
const manifestPath = join(repoRoot, 'apps', 'callweave-unknown-organize', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-unknown-organize-local', '--json'];
