...
const manifestPath = join(repoRoot, 'apps', 'callweave-audio-source-configure', 'app.manifest.json');
const args = [
  'run',
  '-q',
  '--manifest-path',
  traverseManifestPath,
  '-p',
  'traverse-cli-rs',
  '--',
  'app',
...
const child = spawnSync('cargo', args, {
  ...
  env: {
    ...process.env,
    TRAVERSE_RUNTIME_HOME: runtimeHome,
