...
const manifestPath = join(repoRoot, 'apps', 'callweave-review-prepare', 'app.manifest.json');
const args = ['run', '-q', '--manifest-path', traverseManifestPath, '-p', 'traverse-cli-rs', '--', 'app', 'register', '--manifest', manifestPath, '--workspace', 'callweave-review-prepare-local', '--json'];
