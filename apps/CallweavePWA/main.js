...
function shell(content) {
  return `<div class="app-shell">
    ...
    <aside class="rail"><div class="wordmark"><i></i><b>Callweave</b></div><nav>${navItem('today','Today')}<button class="rail-listen runtime-button" type="button" data-action="start-listening">${icon('listen')}<span>Listen</span></button><div class="rail-spacer"></div>${navItem('settings','Settings')}</nav></aside>
    <main class="main">${content}</main>
    <nav class="mobile-nav">${navItem('today','Today')}${listeningNavItem()}${navItem('settings','Settings')}</nav>
  </div>`;
}
