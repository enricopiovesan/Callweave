...
application contracts remain draft; eight reusable, standalone WASI capability
...
behavior contract for the pure portions of `observation-manage`,
`knowledge-manage`, `daily-create`, `daily-close`, and `operations-recover`.
